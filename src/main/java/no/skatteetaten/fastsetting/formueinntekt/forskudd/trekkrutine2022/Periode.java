...
public enum Periode {
    ...
    PERIODE_14_DAGER(26.26d, 23d,             26d, 24d,             26d, 23d,   50, 46000 ),
    PERIODE_1_UKE   (52.52d, 46d,             52d, 48d,             52d, 46d,   20, 23000 ),
    PERIODE_4_DAGER (60.60d, (60d*46d)/52d,   91d, (91d*11d)/12d,   91d, (91d*10.5d)/12d, 20, 19900 ),
    PERIODE_3_DAGER (80.80d, (80d*46d)/52d,  122d, (122d*11d)/12d, 122d, (122d*10.5d)/12d, 20, 14900 ),
    PERIODE_2_DAGER(121.20d, (120d*46d)/52d, 183d, (183d*11d)/12d, 183d, (183d*10.5d)/12d, 20, 9900 ),
    PERIODE_1_DAG  (242.40d, (240d*46d)/52d, 365d, (365d*11d)/12d, 365d, (365d*10.5d)/12d, 20, 4900 );
